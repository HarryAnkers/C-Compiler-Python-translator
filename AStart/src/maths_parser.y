...
DEC_FUNCTION : TYPE T_ID T_LBRACKET T_RBRACKET T_LCUBRACKET BODY T_RCUBRACKET {$$ = new Function(*$2, $6);}
...
DECLARE_VAR : TYPE T_ID T_ASSIGN EXPR T_SEMICOLON {$$ = new DeclareStatement(*$2, $4);}  
    | TYPE T_ID T_SEMICOLON {$$ = new DeclareStatement(*$2);}

FUNCTION : T_ID T_LBRACKET T_RBRACKET T_SEMICOLON;
