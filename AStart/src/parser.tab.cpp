...
static const char *const yytname[] =
{
  ...
  "T_NUMBER", "T_ID", "T_RETURN", "$accept", "ROOT",
  "ARGUMENT_LIST_NO_TYPE", "FUNCTION_STATEMENT", YY_NULLPTR
};
#endif
